...
## About the Project
I was inspired by the *Stranger Things* S1E3 episode "Holly, Jolly" to create my own window display for the Christmas season. Powered by a RaspberryPi and RGB adressable lights, you can create an endless pallate of colors, patterns, and messages to decorate your home for the holidays.  

[Inspiration video](https://www.youtube.com/watch?v=jIQ9z2bxXyg)
...
- RaspberryPi 2 Model B+ : I had this one laying around, but any version 2 or higher will work.
...
- [12V DC Power Jack Adaptor](https://www.amazon.com/gp/product/B01J1WZENK/ref=ppx_yo_dt_b_search_asin_title?ie=UTF8&psc=1)
- [5V 10A Power Supply](https://www.amazon.com/gp/product/B07H9XRZBP/ref=ppx_yo_dt_b_search_asin_title?ie=UTF8&th=1) 
